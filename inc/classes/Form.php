...
//            $output.="<label class='{$this->col_sm_label} control-label' for='{$this->name}' >{$this->label_text}</label>";
    ...
    public function checkbox()
    {
        ...
        if (isset($this->name) && isset($this->label_text)) {
            ...
            $output .= "<input type='checkbox' name='{$this->name}' id='{$this->name}'";

            if (isset($_POST[$this->name]) && (int)$_POST[$this->name] == 1) {
                $output .= " checked ";
            ...
            $output .= ">";
            $output .= "<label class='onoffswitch-label' for='{$this->name}'>";
            $output .= "{$this->label_text}";
            $output .= "</label>";
            $output .= "</div>";
            $output .= "</div>";
            $output .= "</div>";
...
//                echo "<hr>";
//                echo $this->checkboxinline[$i][1]['name'] ;
//
//                echo "<hr>";

                if (isset($_POST[$this->checkboxinline[$i][1]['name']])) {
                    if ($_POST[$this->checkboxinline[$i][1]['name']] == (int)$this->checkboxinline[$i][1]['value']) {
                        $output .= " checked ";
                    }
                } else {
                    if (isset($this->value)) {
//                        echo "<script>alert('xxxxx----$this->value')</script>";
//                        return;
